...
that will be the root of the project folder of 'backend-go'
...
- study_activites - a specific study activity, linking a
study session to group
 - id integer
 - study_session_id integer
 - group_id integer
 - created_at datetime
- word_review_items - a record of word practice,
determining if the word was correct or not
 - word_id integer
 - study_session_id integer
 - correct boolean
 - created_at datetime
...
This task will initialize the sqlite database
...
The file names shhould look like this:
...
In our task we should have DSL to specify each seed file and it's expected group word name.
